                ...
                <div class="primary-header-inner">
                    ...
                    <div class="header-menu-wrap">
                        ...
                        <div class="header-right">
                            <a href="#" class="mt-primary-btn header-btn">Get A Quote</a>
                            ...
                            <div class="header-right-item">
                                <a href="javascript:void(0)" class="mobile-side-menu-toggle d-lg-none"><i class="fa-sharp fa-solid fa-bars"></i></a>
                            </div>
                        </div>
                        <!-- /.header-right -->
                    </div>
